...
The task at hand was to look at the detailed drawing, and decide which color from the palette would be used for this coordinate.

The value was then set via TCE. No mouse but some people built a joystick. Most productive, Akiman, used a play keyboard.
