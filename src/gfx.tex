...
The channels mentions earlier are now visible. ROM \icode{01} and ROM \icode{02} are respectively on channel 1 and channel 2. The same division is applied to the rest of the ROMs. 
