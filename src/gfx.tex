...
By looking at the sheet from later titles, it was inferred that Capcom abandonned the sheet system with the advent of the CPS-2. Likely using a fully computerized toochain devoid of paper and scissors, sheets have no spacial coherency, and they look like mashed potatoes.
% \end{trivia}
