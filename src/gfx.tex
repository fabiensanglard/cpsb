...
However, it was often the case that the lead designer took care of the first iteration, while delegating the fine-tuning to OBJ artists. In the case of Final Fight (p\pageref{ff_design}, Satoru Yamashita animated Guy and Haggar but Akiman drew the key animations for both of them.
...
\begin{tabularx}{\textwidth}{rX} 
  \toprule 
  \textbf{Extension Name} & \textbf{Function} \\               
  \toprule    
...
\texttt{SMI-7056} & Supercharger: 5 MHz Intel 8086 CPU / 256 KiB RAM.\\ 
...
\toprule
\end{tabularx}%
\caption*{SMC-70 extensions and peripherals}
\end{figure}
...
In the pack can be found the first 3.5" floppy reader (also invented by Sony in 1981), coming in single or double bay.
...
"I used a keyboard to draw all the graphics for Vampire and Street Fighter 2" \href{https://twitter.com/akiman7/status/386598518380453888}{LINK}
...
The  noteworthy features 
 ability to display kanji character and its usage of 3.5inch micro-floppy disk (also invented by Sony in 1981).

Running on CP/M OS.
Sony's machine featuring  It could be extended had high resolution of 320x200 in 16 colors and...no mouse!

The tool used, TCE (Tiny Character Editor), ran on a SMC-70.


%  \begin{figure}[H]
%  \center
% \begin{tabularx}{0.25\textwidth}{rrr} 
...
Everyone on the development thought Final Fight was going to be made on hardware with a large memory capacity, but that turned out not to be true. That’s why the final boss Belger hops around like that: we didn’t have enough memory to add more graphics for a walking pattern. However, making something cool with limited resources is like a puzzle to me, so I thought it was fun. 
\end{q}
