...
The OBJ attribute WORD use the following layout.
...
The number of opponents on screen was restricted to 5 which is less than the arcade version where up to 8 enemies where visible. In all likelihood, this was done because the 32 KiB VRAM could not hold all tiles necessary.
