...
The sprites are rendered using the Sprite layer but notice how grass is also there. If rendering the wind blowing was only about swapping tile ID on CPS-1, the X68000 could not software render that much in the Graphic planes. Hence the grass in the sprites
