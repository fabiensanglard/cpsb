...
\subsubsection{OS}
The operating system, Human68k, looks a lot like DOS from Microsoft. It even features english name commands such as \icode{DIR} but the resemblances stops there.
