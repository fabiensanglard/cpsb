...
\textbf{TIP :} Tiles using priority group often use a palette where "high priority" colors are grouped together. This makes it easy to tag them in the bitfield because the bits are next to each others. e.g: Mask \icode{0xF000} marks pens \icode{15}, \icode{14}, \icode{13}, and \icode{12} as high priority.
