...
\begin{wrapfigure}[31]{l}{0.6\textwidth}\simg{0.6}{x68k_front.png}\end{wrapfigure}
...
In later revisons, \icode{HIGH RESO} was replaced with \icode{HD BUSY} to indicate HDD state.


Oh my God. It even has an orange power button.

\pagebreak%
\begin{wrapfigure}[6]{l}{0.6\textwidth}\simg{0.6}{x68k_back.png}\end{wrapfigure}
...
Besides its gorgeous "Manhattan" case, the machine packed a surprising amount of horse power. Its graphic system supporting 128 hardware 16x16 tiles surpassed both dedicated arcade hardware and home-console capabilities at the time it was released.
...
These limitation did not deter Capcom from releasing five games for the platform, Ghouls 'n Ghosts, Final Fight, SF2CE, Super Street Fighter II, and Strider. 
 ...
 For some games developers were able to release "perfect port" which were visually identical to the arcade version. Capcom's Ghouls 'n Ghosts and Street Fighter 2 are considered perfect whereas in Final Fight the number of enemies on screen had to be lowerd to handle loading time.
