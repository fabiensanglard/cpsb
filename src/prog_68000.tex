...
Next to no information has ever transpired regarding how the CPS-1 control system was programmed. However a machine in particular has been widely rumored. A rumor seemingly confirmed by the nickname of Hiroaki Kondo, a Capcom composer/sound programmer often credited as "X68K". A rumor further renforced by what is the components found inside closely matching the CPS-1.

The X68000 is a machine largely unknown outside of Japan. But in the peninsula it is known a the "god computer". 
...
\vfill
 ...
 \begin{figure}[H]
\nbimg{68000.png}
\caption*{The SHARP x68000 God Computer}
\end{figure}
...
Video System & \\
Graphic System & \\
Sprite System & 128 tiles total. 32 tiles lines.\\
...
In fact, former  in the games he worked on.

Max VRAM can host 256 tiles. And draw 128. 32 per lines. Sprite doubler by Koichi Yoshida\cite{x68000spritedoubler}
