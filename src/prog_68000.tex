...
Final Fight uses the same architecture as Ghouls 'n Ghosts. It is a faithful port except for the restricted number of enemies on screen to lower the 32 KiB VRAM stress.

The stair trick is is done with a special blending mode where the MSBs indicates precedence over the Sprite layer. Therefore, the Background uses 128 colors instead of 256.
