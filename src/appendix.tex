...
The build system is a custom Golang program able to generate operate in a single \icode{build.go} command. It takes 1m53s to generate the whole PDF in release mode (300dpi). An incremental debug mode (100dpi) completes within 10s. 
