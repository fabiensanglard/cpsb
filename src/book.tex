...
{
\begin{tcolorbox}[parbox=false, sharp corners,after skip=10pt,top=6pt]%
}
{ 
...
\subfile{src/forewords-fr}

\tableofcontents 

\subfile{src/aknowledgments-fr}
\subfile{src/bug_reports-fr}
\subfile{src/cheat_sheet-fr}
\subfile{src/introduction-fr}
\subfile{src/hardware-fr}
\subfile{src/programing-fr}
\subfile{src/gfx-fr}
\subfile{src/prog_z80-fr}
\subfile{src/prog_68000-fr}
\subfile{src/people-fr}
\subfile{src/epilogue-fr}
\subfile{src/appendix-fr}
