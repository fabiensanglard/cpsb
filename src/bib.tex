...
\bibitem{retro}
  ...
  The vertical refresh rate in H40 is not the number we would get if we were to inject the dot-clock, number of dots, and number of lines in the formula. This is because the Genesis designers want to have the same rate in H32 and H40 modes (59.92 Hz). The dot-clock slows down to 5.37MHz for 28 dots during VBLANK. (Conversation with Upsilandre) .
