...
\bibitem{becareful} 
  ...
  The figures of "two years and five millions dollars" should be taken carefully. These numbers were found on a Forgotten World flyer (\pageref{fw_flyer}) which also mentioned three Motorola 68000 whereas the final product only included a single one. 
  1989.
...
\bibitem{retro}
  ...
  The vertical and horitzontat rates in H40 are not the number we would get if we were to inject the dot-clock, number of dots, and number of lines in the formulas. This is because the Genesis designers want to have the same rate in H32 and H40 modes (59.92 Hz). The dot-clock slows down to 5.37MHz for 28 dots during VBLANK, resulting in 59.92 Hz VSYNC and 15,700 KHz HSYNC. (Conversation with Upsilandre).
