...
The dawn of Capcom history saw more titles doing well despite their limited technology. In 1985, "Wolf of the BattleField" (a.k.a Commando)\index{Games!Commando}, conquered the world and particularly UK where test locations resulted in orders of a thousand units\cite{cgm4}.
...
Released in 1984, Ghost'n Goblins\index{Games!Ghost'n Goblins} is another video-games which is emblematic of Capcom's capacity to do more with less in its early days. 
...
The first mega-hit came with "Final Fight"\index{Games!Final Fight} in 1989. Up to that point in time, the "beat 'em up" genre had been dominated by Technos thanks to its excellent series of Kunio-kun (known outside of Japan as "Renegade") and mega-hit Double Dragon. 
...
Sitting at the intersection of Capcom's new found technology and the "more-with-less" skills its teams had acquired in the necessity of survival, "Street Fighter 2"\index{Games!Street Fighter 2} was a quantum leap in gaming that resulted in a phenomenon.  
...
The goal of this work is to understand the CP-System, from the bottom to the top. This will (hopefully) be achieved by first exposing the hardware and then progressing moving up, all the way to the programming and game engine architecture level.
