...
Released in 1984, Ghost’n Goblins is another emblematic of Capcom's capacity to do more with less. 

With the same limited technology of Commando board, and the same director Tokuro Fujiwara, a small team made of three people, programmer Toshio Arima, artist Masayoshi Kurokawa, and composer Ayako Mori managed to create another hit.
...
The game became playable but resulted in unimpressive graphic and sluggish controls. The cabinet was largely ignored and despite attempt to boost sales with discounts, "the most amazing dedicated upright ever" soon fell into oblivion.
...
\section{A new era}
With the cumulation of competitions, production difficulties, and piracy, Capcom's future looked uncertain. But far from failing, they did better than surviving. They strove. 
...
This book is a engineering love letter to the system that enabled Capcom to transform from a company fighting for survival to become an arcades household.

The goal is to understand the CP-System completely starting down from the metal and moving up all the way to the game engine level.
