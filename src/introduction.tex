...
\end{figure}
 ...
 With Forgotten Worlds using a "new technology" (later named CPS and then CPS-1), Capcom production quality improved. Not only massive sprites moved on the screen, they were made of many more colors.
...
In the first chapter, the hardware of the three systems making the CPS is described in excruciating details. Beyond the hard reality of silicon and wires, a discussion of the design choices is be provided when relevant.

The sub-sequent chapters study the software powering the hardware and how to produce it.
