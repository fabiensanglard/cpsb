...
The pattern common to all these tile is simple. Capcom could not rely on its technology to sell games. What they lacked in raw power they had to made it up with imagination, tinkering, and heart.
\vfill 
...
Fantasy universes were quite popular in the 80s. 
\vfill 
\begin{figure}[H]
\img{gb_flyer.png}
...
The first mega-hit came with "Final Fight" in 1989. Up to that point in time, the "beat 'em up" genre had been dominated by Technos thanks to its excellent series of Kunio-kun and Double Dragon. With Cody, Guy, and Mike, Capcom cleared the room. Artists used the full capability of the CPS-1 to provide gorgeous visuals and engaging musics. The game-play was fantastic. And more importantly the timing was right for the US market where "beat 'em up" were all the rage.
