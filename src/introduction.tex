...
The name "\textbf{Cap}sule \textbf{Com}puters" perfectly summarized what the company stood for. Intending to extend beyond the trendy personal computers of the era, the "coin-ops" were sold as "capsules packed to the brim with gaming fun". The hard outer shell embodied the desire to protect intellectual property, prevents illegal copies, and inferior imitations

After a merging in 1981 the resulting entity, Sanbi, was renamed to "Capcom" in 1983. The first cabinet, released the same year, was a base-ball title named "Little League". In 1984, Capcom entered the world of video-games with their first title "Vulgus".
...
From a technical standing point, Capcom's valiant board featured a 6Mhz z80 with a graphic system capable of animating one sprites layer on top of one text layer, and two background layers. 

The sound system, piloted via a 3Mhz z80 generated both musics and sound effect via Yamaha FM synthesis.

On the opposing corner, Sega's platform named "X Board", was on a league of its own. Running with a dual 12.5 MHz Motorola 68000, the graphic processor Sega Super Scaler chipset 50MHz was capable of both scaling and rotating up to 256 sprites, had two background layers, one "road" layer, and even raycasting capabilities. 
...
% but 
Despite its simple graphics, 1943 sold honorably, even becoming the second highest-grossing table arcade game of 1987 thanks to an engaging gameplay. 

More titles of Capcom early history did well. In 1985, "Wolf of the BattleField" a.k.a Commando, conquered the world and in particular UK where test locations resulted in an order of a thousand units.
...
Released in 1984, Ghost’n Goblins is another hallmark of Capcom early history. 

With the same limited technology of Commando and the same director Tokuro Fujiwara, a three-people team made of programmer Toshio Arima, artist Masayoshi Kurokawa, and composer Ayako Mori managed to create another hit.

The fantasy inspired title featured monsters, knights, medieval weapons, and the most unforgiving gameplay known to mankind. 

It became the tenth highest-grossing table arcade game in Japan, while it took the nineth spot in USA.
...
The fantasy theme was popular in the 80s as attest the myriad of hollywood movies. 
\vfill 
\begin{figure}[H]
\img{gb_flyer.png}
...
Occasionally, wit would not to be enough. In 1987, Capcom published "Street Fighter", an audaciously innovative title but a commercial failure.
...
Besides facing technologically advanced competitors, Capcom had to deal with a complex production pipeline. Looking at the Printed Circuit Boards (PCBs) hosting their games from 1984 to 1987 reveals a high variations of components.
...
Since its PCBs were made with of-the-shelf components, counterfeiters where able to physically copy them, dump the ROMs and load them in "bootleg". 
...
\section{A new era}
With the cumulation of competitions, production difficulties, and piracy, Capcom's future looked uncertain. Far from failing, they did better than surviving. They strove. 

A new era started in 1988. With the release of Forgotten Worlds and Strider, players got a first glimpse into the kind of games the Osaka company was capable of.  
...
The overall quality of "Final Fight" established Capcom as an unarguable AAA arcades games producer.
...
Not only quality improved, quantity also increased. Thanks to its stable platform and tools, Capcom was able to release more than thirty tile between 1988 and 1995, all based on its CPS-1 platform. And then in 1991 came the worldwide mega-hit, "Street Fighter 2".
...
And what to say about the outstanding graphics and full screen 60Hz animation?
...
The game immediately developed a cult following. Players had to wait in lines to drop quarters in the cabinet. The popularity was such that tournaments with cash rewards were held. 

Operators purchased multiple cabinets\cite{sf2_oral_history} to reduce the wait time but at the end of the days machines still overflowed with coins.
...
The goal is to understand the CP-System completely starting from the lower level and marching to the upper layers.
