...
This book is a engineering love letter to the system that enabled Capcom to evolve from a company fighting for survival to an arcade powerhouse and household name.

The goal of this work is to understand the CP-System, from the bottom to the top. This will be achieved by first exposing the hardware and then progressively moving up, all the way to the programming and game engine architecture level.
