...
On the opposing corner, Sega's platform named "X Board", was on a league of its own. Running with a dual 12.5 MHz Motorola 68000 CPUs. The graphic processor, Sega Super Scaler chipset 50MHz was capable of both scaling and rotating up to 256 sprites, had two background layers, one "road" layer, and even raycasting capabilities. 
...
More titles of Capcom early history did well. In 1985, "Wolf of the BattleField" a.k.a Commando\index{Commando}, conquered the world and in particular UK where test locations resulted in an order of a thousand units.
...
Released in 1984, Ghost’n Goblins\index{Ghost'n Goblins} is another emblematic of Capcom's capacity to do more with less. 
...
Besides facing technologically advanced competitors, Capcom had to deal with a complex production pipeline. Looking at the Printed Circuit Boards\index{Printed Circuit Boards} (PCBs)\index{PCB} hosting their games from 1984 to 1987 reveals a high variations of components.
