...
Since Capcom's PCBs were made with off-the-shelf components, counterfeiters were able to copy them, dump the software ROMs and build replicas called "bootlegs". 
