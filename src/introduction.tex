...
Sega's platform named "X Board", was in a league of its own. Its core ran on dual 12.5 MHz Motorola 68000 CPUs. The graphic processor, the Sega Super Scaler chipset clocked at 50MHz, was capable of both scaling and rotating up to 256 sprites, over two background layers, and one "road" layer. 
...
\toprule    
\end{tabularx}%
}\caption*{CPS-1 games: other (\ocube), platform (\platcube), shmup (\shmupcube), brawl (\beatallcube), duel (\duelcube)}
\end{figure}
