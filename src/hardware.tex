...
The star tiles are stored in GFXROM but a pseudo-random generator cycle the colors from the STAR1 and STAR2 set of 32 palettes. By using the palettes astutely, these two layers can simulate fields of stars. 
