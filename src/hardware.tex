...
Because only half a line was drawn at the bottom, the gun only progressed down half a space vertically. As a result, the next frame will be interlaced with the previous. This is a technique used for TV broadcasts, for which the USA and Japan used the NTSC standard. A signal transmits frames at 30Hz, each contains two "fields" to be drawn interlaced at 60Hz.
