...
These CRTs of the early 90s were meant to TV sets consuming NTSC broadcast so the two imperatives were to be close to \textbf{59.95 Hz} VSYNC rate and \textbf{15,734 Hz} HSYNC rate. 
...
\begin{align*}
 \mathtt{Display\;Aspect\;Ratio = PAR * SAR = \frac{(45*320)}{(44*224)} = 1.46}
\end{align*}
