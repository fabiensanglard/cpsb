...
\nbdraw{palette_title}
 ...
 % In an extraordinary coindicence, it was a match.
...
\begin{trivia}
Pull-up resistors on the board along the GFX ROM data lines detect if a pen value matches a tileID. If not data is detected, \icode{0xF} is automatically "inserted", resulting in a transparent value.
\end{trivia}
