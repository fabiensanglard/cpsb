...
\begin{trivia}
The number of pin lines on a chip dictate their packaging names. DIP (Dual In-line Package), like the z80 below, are recognizable by their two lines of pins. The Motorola 68000 on page \pageref{68000drawing} with its four sides of pins belongs to the "Chip carrier" family. 

Packaging can use materials such as plastic or ceramic in which cases they are referred using increasingly barbaric acronyms such as CLCC or PLCC.
\end{trivia}
