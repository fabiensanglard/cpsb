...
The CPS-1 with its resolution of \icode{384x224} and its dot-clock of 8,000,000 Hz results in a PAR of 135:176. Its output signal somewhat matches the CRT aspect ratio of 4:3. 

\begin{align*}
 \mathtt{Display\;Aspect\;Ratio = \frac{(135*384)}{(176*224)} = 1.31}
\end{align*}

However its narrow pixel generates a significant amount of distortion which was a huge problem for artists. If they digitized their drawing as is, the CRT would present to players a vertically stretched version of their original vision. As illustrated on page \pageref{sf2_ratio}, an artist drawing a circular sun on paper, digitizing it as is and running it via the CPS-1 would see an oval result on the screen.
...
How artists managed to work around this annoying "feature" of the platform is revealed on page \pageref{artists_par}.
 
In the rest of the book, the format of images will vary. For real-estate reasons, the "screenshot" may be shown with 1:1 aspect ratio or 1.3 aspect ratio depending on the needs. The same goes with the drawings. Since the difference is pretty significant between squares and rectangles (as seen on page \pageref{sf2_ratio_solution}) the aspect ratio is not mentioned again.
...
\label{sf2_ratio}
\vfill
\sbimg{0.98}{sun_4_3.png}

\pagebreak

\sbimg{0.98}{sf2_intro.png}
\label{sf2_ratio_solution}

\sbimg{0.98}{sf2_intro_4_3.png}
...
Before moving to the color generator, a characteristic to decide on is the color depth. 
