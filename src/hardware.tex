...
\begin{figure}[H]
\nbdraw{speaker}
\caption*{A speaker cone moves via a coil interacting with a magnet.}
\end{figure}
...
The higher the sampling rate (on the X axis) , the more often the diaphragm position can be adjusted. The higher the bit depth (on the Y axis) , the more accurately the diaphragm position can be set. Stereo is achieved by interleaving two PCM streams.
