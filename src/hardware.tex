...
Because only half a line was drawn at the bottom, the gun only progressed down half a space vertically. As a result, the next frame will be interlaced with the previous. This is a technique used for TV broadcasts, such as in the NTSC standard in USA and Japan. A signal transmits frames at 30Hz, each contains two "fields" to be drawn interlaced at 60Hz.
