...
To achieve this effect, the CPS-B allows the SCROLL layer behind the OBJs to tag its tiles. Tagged tiles pens are looked up against up to four mask (each allowing four pen values) indicating which pens have precedence over OBJ.
...
Once the exit animation is over, all tiles are unmarked to allow free roaming (except behind the ramp) and brawling over the whole screen without priority concerns.
