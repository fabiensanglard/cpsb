...
The system was revised over the years. Approximately 229 variations are known to exist, including bootlegs. The board which will be studied in this book is the one used to run the original "Street Fighter 2", which uses board A (88617A-7B), board B (90629B), and board C (90628-C).
...
\subsection{Motorola 68000}\index{Processors!Motorola 68000}
 ...
 Released in 1979, and clocked at 10 MHz (later upgraded to 12 MHz), the MC68000 was not a particularly powerful chip by the late 80' standards with its two stage pipeline\cite{M68000fv} (prefetch, exec) and no cache. Its 1.7 MIPS placed it on par with an Intel 286 10MHz (1.5 MIPS). By 1989 it was already two generations old behind the 1984 M68020 (3 MIPS) and the 1987 M68030 (5 MIPS)\cite{mips}.
