...
The star tiles are stored in GFXROM but a pseudo-random generator cycles the colors from the STAR1 and STAR2 set of 32 palettes. By using the palettes astutely, these two layers can simulate fields of stars. 
...
The 23-bit address line to the GFX ROM is special. It is not a raw address but a descriptor containing the layerID and a tileID within this layer. Since all layers have known tile dimensions, the PAL \icode{STF29} can decode addresses into a raw offset.
