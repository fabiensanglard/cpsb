...
Besides interlacing which had to be avoided, many other key decisions had to be made by the hardware engineers. Namely, how many lines to draw, how much horizontal resolution to use, and at what frequency should the screen be fully redrawn (a.k.a: "refreshed").
