...
Little RAM is needed by the Z-80 since it forwards request from the latches to the OKY6295 and feeds the YM2151 music notes. A  single 2Ki x 8-bit \icode{CXK5816SP-15L} chip is used. The ROM is made of a 64Ki x 8-bit \icode{27C512} cip. It is large to store FM musics along the z80 instructions. 
