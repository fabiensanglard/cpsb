...
While other chips on the board-B are \icode{27C010} and \icode{27C512}, the GFXROM is made of \icode{MB834200B} (256 Ki x 16-bit). This type of ROM have a much higher capacity but also a slower access time (150ns). To compensate they are arranged in two concurrently addressed banks in two 32-bit "channels" data path.
