...
\section{Physical Architecture}
 The CPS-1 is made of three Printed circuit boards named "A", "B", and "C" and stacked on top of each others. The boards A and B are connected via four 2x32-pins connectors while the boards B and C are connected with four 2x20-pin connectors.
