\chapter*{Aide-mémoire des capacités}

Il est dangereux de partir seul. De nombreuses puces sont étudiées dans le chapitre sur le matériel. Compter les broches et en déduire leur capacité peut facilement mener à des erreurs de type "décalage de un".
...
\makebox[\linewidth]{ % To center the tabular
\begin{tabular}{rrr}
...
\end{minipage}
\caption*{Table de vérité du nombre de broches}
\end{figure}
