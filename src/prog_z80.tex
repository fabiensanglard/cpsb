...
Alike the PC-88, the PC-98 enjoyed considerable success. Over its lifespan ranging from 1992 to 2000, NEC sold more than 18 millions units. Across multiple lines such as "Desktop", "Hi-end", or "Laptop", NEC released a new machine every year. 
...
\toprule    
  ...
  \texttt{1992} & \texttt{} & \texttt{}    & \texttt{}         & \texttt{}\\
  \texttt{1993} & \texttt{9801BA} & \texttt{486}    & \texttt{40}         & \texttt{}\\
  \texttt{1994} & \texttt{} & \texttt{}    & \texttt{}         & \texttt{}\\
  \texttt{1995} & \texttt{9821C } & \texttt{586}    & \texttt{75}         & \texttt{}\\
  \toprule    
\end{tabularx}%
