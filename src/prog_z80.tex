...
A single latch is used to receive commands as "immediate values". If bit 0x80 is set, control is requesting a sound effect to be played, otherwise it is music. 
