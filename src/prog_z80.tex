...
\subsection{Processing Sound Samples}
...
\subsection{Structure of the OKI ROM}
...
\subsection{Programming the Z-80}
Programming Zilog's CPU into a sound driver involves doing two things right, bootstrapping and behaving according to the memory map.   

Solving the memory map is the easier. To avoid page turning, the requirement is reproduced here.
