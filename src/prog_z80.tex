...
The success was such that the series accounted for 60\% of the Japanese market Personnal Computer market in 1991. The domination only wandered once DOS/V, a special version of Microsoft's MS-DOS supporting Japanese characters, came out at the end of 1990.


\subsubsection{Tech Specs}

1987 9801UX 286 10MHz
1990 9801DA 386 20MHz
1993 9801BA 486 40MHz
1995 9821C  586 75Mhz
...
From a tech specs perspective, the PC-98 uses its own 16-bit C-bus (Cバス) instead of the ISA bus; BIOS, I/O port addressing, memory management and graphics output are also different.
