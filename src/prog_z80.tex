...
NEC entered the personnal computer market in 1979 with its 8800 series. These machine, build around 8-bit Zilog 80 CPUs would later be known as "PC-88". 

Thanks to its optinal kanji ROM NEC quickly gained traction, accounting for 40\% of the Japanese personnal market by 1981.
...
Because so many models were released, it is hard to tell for sure which PC-98 was used for a particular game. What can be done is list the top of the "Hi-end" line for each years CPS-1 games were released in order to get an idea.

% \begin{figure}[H]
% {
% \begin{tabularx}{\textwidth}{rXrrr}
% \toprule    
%   \textbf{Year }& \textbf{Model  }& \textbf{CPU }   & \textbf{Freq (MHz)} & \textbf{RAM } \\               
  
% \toprule    
%   \texttt{1987} & \texttt{9801UX } & \texttt{286}    & \texttt{10}         & \texttt{}\\
%   \texttt{1988} & \texttt{} & \texttt{}    & \texttt{}         & \texttt{}\\
%   \texttt{1989} & \texttt{} & \texttt{}    & \texttt{}         & \texttt{}\\
%   \texttt{1990} & \texttt{9801DA } & \texttt{386}    & \texttt{20}         & \texttt{}\\
%   \texttt{1991} & \texttt{} & \texttt{}    & \texttt{}         & \texttt{}\\
%   \texttt{1992} & \texttt{9801FA } & \texttt{486}    & \texttt{16}         & \texttt{}\\
%   \texttt{1993} & \texttt{9801BA } & \texttt{486}    & \texttt{40}         & \texttt{}\\
%   \texttt{1994} & \texttt{9821Cf } & \texttt{Pentium}    & \texttt{60}         & \texttt{}\\
%   \texttt{1995} & \texttt{9821Cx3} & \texttt{Pentium}    & \texttt{100}         & \texttt{}\\
%   \toprule    
% \end{tabularx}%
% }\caption*{Some of NEC computers, 8800 and 9800 series.}
% \end{figure}
